...
const arun = "/images/arun.jpeg"
const darnell = "/images/darnell.jpeg"
const denise = "/images/denise.jpeg"
const jamel = "/images/jamel.jpeg"
const keith = "/images/keith.jpeg"
const maxine = "/images/maxine.jpeg"
const micah = "/images/micah.jpeg"
const rick = "/images/rick-cabrera.jpeg"
const russell = "/images/russell.jpeg"
const walker = "/images/walker-smith.jpeg"
...
Principal Group Engineering Manager (Director)"
    >
      ...
      <Typography level="body-md" sx={{ marginBottom: 2 }}>
        ...
        well-earned nickname that speaks to his natural ability to mentor and
        guide others. He excels at helping early-in-career engineers grow,
        teaching them solid engineering practices, design patterns, and how to
        effectively break down complex problems into clear, manageable
        solutions.
      </Typography>
      <Typography level="body-md" sx={{ marginBottom: 2 }}>
      ...
      <Typography level="body-md" sx={{ marginBottom: 2 }}>
        ...
        mentorship, and continuous improvement. I highly recommend Andrew to any
        organization looking for a principled and forward-thinking engineer who
        leads with both skill and generosity.
      </Typography>
    </Recommendation>
  )
}
const Rick = () => (
  ...
  >
    <Typography level="body-md" sx={{ marginBottom: 2 }}>
      Andrew is a fantastic software developer. He was hired on at Experience to
      bring focus and leadership to our front-end technology stack and his
      impact has been significant. His technical acumen and ability to work
      extremely well with our design team has brought beautiful and functional
      components, along with consistency and improved development speed to our
      team.
    </Typography>
    <Typography level="body-md" sx={{ marginBottom: 2 }}>
...
const Darnell = () => (
  ...
  >
    <Typography level="body-md" sx={{ marginBottom: 2 }}>
      ...
      commands engineering excellence through his intentional actions of
      continuous improvement with a strong affinity for effectively establishing
      unique and collaborative mechanisms. His front end ability is unmatched,
...
const Keith = () => (
  ...
  >
    <Typography level="body-md" sx={{ marginBottom: 2 }}>
      Andrew is a talented and passionate engineer whose architectural and
      testing rigor consistently improves whatever application stack he is
      engineering. He is collaborative by nature, happy to learn the
      perspectives of others, and eager to delight the user.
    </Typography>
    <Typography level="body-md" sx={{ marginBottom: 2 }}>
      Andrew is visionary in his approach towards software development. When
      supported by the right team, capable of consuming or building cutting edge
      frameworks. He is an advocate for developer best practices, keenly aware
      of the importance of semantically idiomatic code and the long term value
    ...
    <Typography level="body-md" sx={{ marginBottom: 2 }}>
      If you want to elevate your team by bring in techniques that will enhance
      your quality, upgrade to the newest and most exciting frameworks, and
      really raise the bar for an organization looking for an engineer who can
      mentor and teach, Andrew is your one stop shop.
    </Typography>
  </Recommendation>
)
const Walker = () => (
  ...
  >
    <Typography level="body-md" sx={{ marginBottom: 2 }}>
      ...
      is not only high quality and reliable but deeply thoughtful and impactful.
    </Typography>
    <Typography level="body-md" sx={{ marginBottom: 2 }}>
...
const Jamel = () => (
  ...
  >
    <Typography level="body-md" sx={{ marginBottom: 2 }}>
      I had the pleasure of working with Andrew Smith on the F1Next initiative
      to revamp the M365 In-App Help experience. Andrew brought deep expertise
      in frontend development and architecture, helping to elevate the quality,
      performance, and scalability of the platform. His work was instrumental in
      setting best practices across the engineering team.
    </Typography>
    <Typography level="body-md" sx={{ marginBottom: 2 }}>
...
const Arun = () => (
  ...
  >
    <Typography level="body-md" sx={{ marginBottom: 2 }}>
      ...
      truly unmatched and incredibly inspiring.
    </Typography>
    <Typography level="body-md" sx={{ marginBottom: 2 }}>
      Andrew is the kind of colleague everyone wants on their team. He is not
      only technically sound but also genuinely committed to helping others
      grow. His drive for innovation and excellence is evident in everything he
      does.
    </Typography>
    <Typography level="body-md" sx={{ marginBottom: 2 }}>
      I had the chance to work with him on building the WYSIWYG editor for our
      content platform, implemented JSON editor and a unified editor that
      supports multiple formats for authoring content. His contributions
      significantly improved the flexibility and usability of the platform.
    </Typography>
    <Typography level="body-md" sx={{ marginBottom: 2 }}>
      Andrew is a complete full-stack architect. His precision in engineering
      and eagerness to deliver the best are always impressive. He’s our go-to
      person whenever we face technical challenges. His depth of knowledge, calm
      problem-solving approach, and willingness to help make him an invaluable
      team member.
    </Typography>
    <Typography level="body-md" sx={{ marginBottom: 2 }}>
      He is a great leader, mentor, and guide who supports his peers and helps
      them grow. It’s rare to find someone who combines such deep technical
      skill with humility and a collaborative spirit.
    </Typography>
    <Typography level="body-md" sx={{ marginBottom: 2 }}>
      I highly recommend Andrew for any opportunity that values technical
      excellence, strong leadership, and a passion for innovation.
    </Typography>
  </Recommendation>
)
const Russell = () => (
  <Recommendation
    summarized
    profileImage={russell}
    name="Russell Thatcher"
    company="Matrix Resources"
    title="Software Engineering Leader"
  >
    <Typography level="body-md" sx={{ marginBottom: 2 }}>
      Andrew is one of my best team members. He possesses a deep passion for
      software and technology, and his knack for creative software solutions has
...
const Maxine = () => (
  ...
  >
    <Typography level="body-md" sx={{ marginBottom: 2 }}>
      I had the pleasure of working with Andrew and was especially grateful for
      his support. He jumped in without hesitation, sharing his deep knowledge
      and practical insights that made a huge difference in getting things
      unblocked.
    </Typography>
    <Typography level="body-md" sx={{ marginBottom: 2 }}>
...
const Micah = () => (
  ...
  >
    <Typography level="body-md" sx={{ marginBottom: 2 }}>
      Andrew is motivated and proactive individual in web development. He is
      passionate about his work and enjoys finding opportunities to learn and
      challenge himself. He is detail-oriented and he has the mental stamina to
      wrap his head around complex problems. Andrew brings a positive
      perspective to the workplace and he has a great attitude when faced with
      challenges.
    </Typography>
    <Typography level="body-md" sx={{ marginBottom: 2 }}>
      He is an absolute pleasure to work with and he loves what he does for a
      living. Andrew inspires me.
    </Typography>
  </Recommendation>
)

const featured = [Denise, Rick, Darnell]
const nonFeatured = [Keith, Walker, Jamel, Micah, Arun, Maxine, Russell]

export { featured, nonFeatured }
