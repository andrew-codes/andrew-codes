...
Building a skyscraper is hard. A mastery of mechanical and civil engineering, landscaping, interior design, and many other intersecting disciplines are needed. However, regardless of how masterfully architected or beautifully engineered, it is utterly useless without exterior doors. The only thing that matters is whether it meets the people's needs using it.
...
It is true that whether building skyscrapers or developing software, meeting the end-users' needs is goal and should always be in focus. However, like focusing solely on the craftsmanship will not likely yield the desired result; keeping only a vision of the solution will also fail. A skyscraper built by unskilled workers is as useless as one without doors.
