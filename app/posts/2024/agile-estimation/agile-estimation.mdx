...
There are better mechanisms to forecast project timelines, which I will discuss later. The purpose of estimating stories is not for planning. So, what is the purpose of estimating stories?
...
3. **Relative size**: Estimates should be relative to one another. We are not trying to understand the absolute size of the work, but the relative size.ate, require a great upfront cost for larger bodies of work and reduce agility.
